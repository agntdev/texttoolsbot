# E1T1 — /reverse Command

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TXTBOT

Implement the /reverse command handler in src/handlers/reverse.ts. Trim and reverse the input text. Add test spec to tests/specs/et1.json and register command in tests/commands.json.
