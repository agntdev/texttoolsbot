...
Implement the /upper command handler in src/handlers/upper.ts. Convert input text to uppercase. Add test spec to tests/specs/et2.json and register command in tests/commands.json.
