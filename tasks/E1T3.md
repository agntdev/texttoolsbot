...
Implement the /lower command handler in src/handlers/lower.ts. Convert input text to lowercase. Add test spec to tests/specs/et3.json and register command in tests/commands.json.
