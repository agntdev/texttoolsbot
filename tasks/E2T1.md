...
Implement the /count command handler in src/handlers/count.ts using src/utils.ts's wordCount utility. Report word and character counts. Add test spec to tests/specs/et4.json and register command in tests/commands.json.
