# E3T1 — wordCount Utility

**Weight:** 0.0000 (share of project budget)
**Reward:** 0 TXTBOT

Implement wordCount function in src/utils.ts that splits text on Unicode whitespace and counts non-empty tokens. Used by /count command.
